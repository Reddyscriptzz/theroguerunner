    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center overflow-hidden">
        <div className="text-center">
          <div className={`text-8xl font-bold text-cyan-400 mb-4 transition-all duration-75 font-orbitron ${
          ...
          <div className="text-cyan-300 text-xl font-light tracking-[0.3em] animate-pulse font-exo">
            INITIALIZING...
          </div>
        </div>
      </div>
      ...
      <header className="relative z-10 p-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div className="text-lg font-light tracking-wider font-exo">ROGUE RUNNER</div>
          </div>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] px-6">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mb-8 animate-fade-in">
            <div className="text-9xl font-bold text-cyan-400 mb-4 hover:animate-pulse cursor-pointer transition-all duration-300 font-orbitron">
            ...
            <h1 className="text-4xl font-light tracking-[0.3em] text-cyan-300 mb-2 font-exo">ROGUE RUNNER</h1>
          ...
          <div className="mb-12 animate-fade-in" style={{ animationDelay: '0.5s' }}>
            <h2 className="text-2xl md:text-3xl font-light mb-4 text-gray-300 font-exo">
              Advanced Telegram Trading Bot
            </h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed font-exo">
          ...
          <div className="mb-16 animate-fade-in" style={{ animationDelay: '1s' }}>
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white px-8 py-4 text-lg font-medium rounded-lg shadow-lg hover:shadow-cyan-500/25 transition-all duration-300 group font-exo"
          ...
          <div id="features" className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto animate-fade-in" style={{ animationDelay: '1.5s' }}>
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-lg p-6 hover:border-cyan-500/50 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white font-orbitron">Automated Trading</h3>
              <p className="text-gray-400 font-exo">Execute trades 24/7 with advanced algorithms and real-time market analysis.</p>
            </div>
            
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-lg p-6 hover:border-cyan-500/50 transition-all duration-300 group">
              <TrendingUp className="h-8 w-8 text-cyan-400 mb-4 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-semibold mb-2 text-white font-orbitron">Smart Analytics</h3>
              <p className="text-gray-400 font-exo">Get detailed insights and performance metrics to optimize your trading strategy.</p>
            </div>
            
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-lg p-6 hover:border-cyan-500/50 transition-all duration-300 group">
              <Zap className="h-8 w-8 text-cyan-400 mb-4 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-semibold mb-2 text-white font-orbitron">Lightning Fast</h3>
              <p className="text-gray-400 font-exo">Execute orders in milliseconds with our high-performance infrastructure.</p>
            </div>
          </div>
        </div>
      </main>
      ...
      <footer className="relative z-10 py-8 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            <div className="text-xl text-cyan-400 font-orbitron">
              <span className="inline-block transform">R</span>
              <span className="inline-block transform rotate-180 -ml-1">R</span>
            </div>
            <span className="text-gray-400 font-exo">Rogue Runner</span>
          </div>
